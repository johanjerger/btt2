...
#define MALLOC_ERROR_MSG_CHARACTER "error allocating character_t type pointer."
#define MALLOC_ERROR_MSG_KEYMAP "error allocating keymap_t type pointer."
#define MALLOC_ERROR_MSG_MENU "error allocating menu_t type pointer."
#define MALLOC_ERROR_MSG_MENU_TITLE "error allocating char * type pointer in menu.c."
#define MALLOC_ERROR_MSG_OPTION "error allocating option_t type pointer."
#define MALLOC_ERROR_MSG_OPTION_LIST "error allocating option_list_t type pointer."
#define MALLOC_ERROR_MSG_SCORE "error allocating score_t type pointer."
#define MALLOC_ERROR_MSG_SCORE_PLAYER "error allocating char * type in score.c pointer."
#define MALLOC_ERROR_MSG_SCORE_TABLE "error allocating score_table_t type pointer in 'score_table/score_table.c'."
